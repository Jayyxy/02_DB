...
SELECT EMP_ID, EMP_NAME, EMP_NO, DEPT_TITLE, HIRE_DATE
...
SELECT EMP_ID, EMP_NAME, JOB_CODE, DEPT_CODE, DEPT_TITLE, JOB_NAME 
...
SELECT EMP_NO, DEPT_CODE, MANAGER_ID
WHERE LEFT(EMP_NO,2)= 77 
